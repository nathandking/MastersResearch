%% Level set method for heat equation on a circle (modified).
...
%
% This code has been modified to use interpolation matrices from 
% cp_matrices and plot figures similar to example_heat_circle.m by Steve
% Ruuth and Colin Macdonald.
clear all;
tic
