...
================================
-run_save_initial_map.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_save_initial_map.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v84, run the shell script as:
       ...
       ./run_save_initial_map.sh /mathworks/home/application/v84
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_save_initial_map.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MATLAB runtime using the above  
    link, include it when building your component by clicking 
    the "Runtime downloaded from web" link in the Deployment Tool
-The Macintosh bundle directory structure save_initial_map.app 
   -this can be gathered up using the zip command 
    zip -r save_initial_map.zip save_initial_map.app
    or the tar command 
    tar -cvf save_initial_map.tar save_initial_map.app
-This readme file 
...
A. Mac systems:
   ...
   Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_save_initial_map.sh 
